package com.swfgui.utils
{
	...
	public class StringUtil
	{
		 ...
		 * @return 
		 */
		public static function getPrefix(name:String):String
		{
		...
		public static function replaceAll(p:*, repl:*, source:String):String
		{
			return source.replace(new RegExp(p, "g"), repl);
		}
	}
